...
namespace Shop_Inventory_Management {
    ...
    public partial class DbConnectionDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeRow AddEmployeeRow(int Id, string Name, string Password, string Post, decimal Salary, System.DateTime JoinDate, System.DateTime BirthDate) {
...
namespace Shop_Inventory_Management.DbConnectionDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Password] = @Original_Password) AND ([Post] = @Original_Post) AND ([Salary] = @Original_Salary) AND ([JoinDate] = @Original_JoinDate) AND ([BirthDate] = @Original_BirthDate))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([Id], [Name], [Password], [Post], [Salary], [JoinDate], [BirthDate]) VALUES (@Id, @Name, @Password, @Post, @Salary, @JoinDate, @BirthDate);
SELECT Id, Name, Password, Post, Salary, JoinDate, BirthDate FROM Employee WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Id] = @Id, [Name] = @Name, [Password] = @Password, [Post] = @Post, [Salary] = @Salary, [JoinDate] = @JoinDate, [BirthDate] = @BirthDate WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Password] = @Original_Password) AND ([Post] = @Original_Post) AND ([Salary] = @Original_Salary) AND ([JoinDate] = @Original_JoinDate) AND ([BirthDate] = @Original_BirthDate));
SELECT Id, Name, Password, Post, Salary, JoinDate, BirthDate FROM Employee WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Shop_Inventory_Management.Properties.Settings.Default.DbConnectionConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Password, Post, Salary, JoinDate, BirthDate FROM dbo.Employee";
        ...
        public virtual int Fill(DbConnectionDataSet.EmployeeDataTable dataTable) {
        ...
        public virtual DbConnectionDataSet.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DbConnectionDataSet.EmployeeDataTable dataTable = new DbConnectionDataSet.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DbConnectionDataSet.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Password, string Original_Post, decimal Original_Salary, System.DateTime Original_JoinDate, System.DateTime Original_BirthDate) {
        ...
        public virtual int Insert(int Id, string Name, string Password, string Post, decimal Salary, System.DateTime JoinDate, System.DateTime BirthDate) {
        ...
        public virtual int Update(int Id, string Name, string Password, string Post, decimal Salary, System.DateTime JoinDate, System.DateTime BirthDate, int Original_Id, string Original_Name, string Original_Password, string Original_Post, decimal Original_Salary, System.DateTime Original_JoinDate, System.DateTime Original_BirthDate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Password, string Post, decimal Salary, System.DateTime JoinDate, System.DateTime BirthDate, int Original_Id, string Original_Name, string Original_Password, string Original_Post, decimal Original_Salary, System.DateTime Original_JoinDate, System.DateTime Original_BirthDate) {
            return this.Update(Original_Id, Name, Password, Post, Salary, JoinDate, BirthDate, Original_Id, Original_Name, Original_Password, Original_Post, Original_Salary, Original_JoinDate, Original_BirthDate);
        }
    }
